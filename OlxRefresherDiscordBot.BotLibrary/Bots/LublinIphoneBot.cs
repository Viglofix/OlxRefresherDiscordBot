...
public class LublinIphoneBot : IBot
{
    ...
    public LublinIphoneBot(IDiscordClientService discordClientService, ContractInteractivityConfigurationService interactivityConfigurationService, ICommandsNextConfigurationService commandsNextConfigurationService, IAuthorizationJson authorizationJson)
    {
        _discordClientService = discordClientService;
    }
    public async Task BotRunner()
    {
        var discordClient = await _discordClientService.GetDiscordClient();
        ...
        var task = Task.Run(async () =>
        {
            while (true)
            {
                ...
                var request = new RestRequest("https://www.olx.pl/api/v1/offers/?offset=0&limit=40&query=iphone&category_id=1839&region_id=8&city_id=10119&distance=15&sort_by=created_at%3Adesc&filter_float_price%3Afrom=200&filter_refiners=spell_checker&suggest_filters=true&sl=194a20d203ex7d16ebf2", Method.Get);
