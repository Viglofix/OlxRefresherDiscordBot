...
public class LublinIphoneBot : IBot
{
    ...
    public async Task BotRunner()
    {
        ...
        while (true)
        {
            ...
            var request = new RestRequest("https://www.olx.pl/api/v1/offers/?offset=0&limit=40&query=iphone&region_id=8&city_id=10119&distance=15&sort_by=created_at%3Adesc&filter_float_price%3Afrom=200&filter_refiners=spell_checker&suggest_filters=true&sl=194a20d203ex7d16ebf2", Method.Get);
